...
export default function Page() {
    return (
        <div>
            ...
            <p>
                All the major equipment is now on site. The plant site has been
                built, including the pad, structure, ore ramp, tailings pond,
                and processing tanks. Electrical upgrades are completed, and new
                power systems have been installed. The ball mill and floatation
                systems are on site and being installed. At this point, the
            ...
            <p>
                ...
                will be produced during the testing and commissioning. Testing
                and commissioning should take around 2-3 months, and they are
                looking to complete the ramp-up in 2023.
            </p>

            <h2 className={styles.h2Padding}>Plant 3 - Antioquia. Columbia</h2>
            <p>
                Plant 3 ended up in Colombia because they signed an agreement
                earlier than in Brazil. The Due Diligence is completed, and
            ...
            <p>
                ...
                working with artisanal miners in Costa Rica. They will be
                working on the OTCQB uplisting somewhere in the fall, and they
